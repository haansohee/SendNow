...
final class GroupManagementView: UIView {
    ...
    private let groupNameUpdateTitleLabel: UILabel = {
        ...
        label.font = UIFont(name: FontName.pretendardSemiBold.rawValue, size: FontSize.medium.rawValue)
    ...
    let groupNameTextField: UITextField = {
        ...
        textField.font = UIFont(name: FontName.pretendardRegular.rawValue, size: FontSize.small.rawValue)
