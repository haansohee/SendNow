...
final class GroupListViewModel {
    ...
    private(set) var myGroupList: [GroupListInformation]?
    private(set) var invitedFriendList: [MyFriendList] = []
    ...
    func setInvitedFriendList(friendList: [MyFriendList]) {
    ...
    func loadSelectedFriendList() {
        ...
        let myInformation = MyFriendList(userID: userID, nickname: nickname, kakaoPayUrl: kakaoPayUrl)
        self.invitedFriendList.append(myInformation)
    }
    
    func selectInvitedFriend(friendUserID: MyFriendList) {
        self.invitedFriendList.append(friendUserID)
    }
    
    func deselectInvitedFriend(friendUserID: MyFriendList) {
    ...
    func invitedFriendToGroup(groupName: String, remainderUserID: Int) {
        ...
        let groupCreationDomain = GroupCreationInformation(
    ...
    func sendNotification() {
        ...
        let notificationDomain = GroupNotificationInformation(
            senderUserID: userID,
